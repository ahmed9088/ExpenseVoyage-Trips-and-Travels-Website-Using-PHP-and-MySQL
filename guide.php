    ...
    <style>
        ...
        * {
        ...
        .cta-section {
            ...
            color: white;
            text-align: center;
            margin: 80px auto 100px; /* Added bottom margin */
            max-width: calc(100% - 40px);
        ...
        .testimonial {
            background-color: #f5f7ff;
            padding-top: 150px; /* Added top padding */
        ...
        @media (max-width: 767px) {
            ...
            .cta-section {
                padding: 40px 20px;
                margin: 60px auto 80px; /* Adjusted for mobile */
            }
    ...
    <section class="team">
        <div class="container">
            <div class="text-center mb-5">
                <h6 class="text-primary text-uppercase" style="font-size: 27px;">Travel Experts</h6>
                <h1 class="section-title" style="color:black">Meet Our Guides</h1>
            ...
            <div class="guide-process">
                <div class="text-center mb-5">
                    <h6 class="text-primary text-uppercase" style="font-size: 27px;">How It Works</h6>
                    <h1 class="section-title" style="color:black">Our Guide Process</h1>
                </div>
    ...
    <section class="testimonial">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <h1 class="section-title" style="color: black">What Our Clients Say</h1>
            </div>
            <div class="row">
                <?php
