                    ...
                    <div class="row pb-3">
                        ...
                        if ($num_rows > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<div class="col-md-4 mb-4 pb-2">
                            <div class="blog-item">
                                ...
                                <div class="bg-white p-4">
                                    ...
                                    <a class="h5 m-0 text-decoration-none" href="#">'.$title.'</a>
                                     <a href="#">
                            <button class="btn btn-primary btn-block" type="submit" style="height: 35px; margin-top: 10px;">More Detailes...</button></a>
                                </div>
                            </div>
                        </div>';
                            }
