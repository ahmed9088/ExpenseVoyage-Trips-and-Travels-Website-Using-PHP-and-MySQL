...
<head>
   ...
   <title>Contact View - ExpenseVoyage</title>
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li class="submenu open">
                        ...
                        <ul>
                            <li><a href="contactview.php" class="active"> Contact </a></li>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="datatable-buttons" class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            // FIXED: Removed ORDER BY clause and used proper column access
                                            ...
                                            if(mysqli_num_rows($query) > 0) {
                                                while($row = mysqli_fetch_row($query)) {
                                                    ...
                                                    $id = $row[0];          // Primary key (first column)
                                                    $name = $row[1];        // Name (second column)
                                                    $email = $row[2];       // Email (third column)
                                                    $subject = $row[3];     // Subject (fourth column)
                                                    $message = $row[4];     // Message (fifth column)
                                                    ...
                                                    echo "<tr>
                                                        ...
                                                        <td><div class='message-cell'>".htmlspecialchars($message)."</div></td>
                                                        <td>
    ...
    <script>
        ...
        function confirmDelete(id) {
            if (confirm('Are you sure you want to delete this contact message?')) {
                window.location.href = 'contactdelete.php?id=' + id;
            }
        }
    </script>
</body>
