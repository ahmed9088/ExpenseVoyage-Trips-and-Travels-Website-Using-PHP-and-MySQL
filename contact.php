...
if (!isset($_SESSION['email'])) {
    ...
    $_SESSION['redirect_after_login'] = 'contact.php'; // Redirect to this page after login
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['contactsubmit'])) {
    ...
    if (!empty($name) && !empty($email) && !empty($subject) && !empty($message)) {
        ...
        if ($result) {
            ...
            $_SESSION['contact_message'] = 'Error sending message. Please try again later.';
...
<head>
    ...
    <meta content="Contact ExpenseVoyage for any inquiries about our travel services" name="description">
    <meta content="contact, travel, inquiry, support" name="keywords">
    ...
    color: white;
        ...
        /* Page Header */
        .page-header {
            background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('img/contact-header.jpg');
        ...
        .contact-info::before {
            ...
            width: 100%;
            height: 100%;
            background: url('img/contact-pattern.png') no-repeat center center/cover;
            opacity: 0.1;
            z-index: 0;
        }
...
<body>
    ...
    <?php if (isset($_SESSION['contact_message'])): ?>
        <div class="message-notification <?php echo $_SESSION['message_type']; ?>">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="contact.php" class="nav-item nav-link active animate__animated animate__fadeInDown">Contact</a>
    ...
    <section class="contact">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="lead">Have any questions or need more information? Feel free to contact us.</p>
            </div>
                ...
                <div class="col-lg-8 animate__animated animate__fadeInLeft">
                    <div class="contact-form">
                        <form id="contactForm" method="post" action="">
                            ...
                            <div class="text-center">
                                <button class="btn btn-primary" name="contactsubmit" type="submit" id="sendMessageButton">Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-lg-4 animate__animated animate__fadeInRight">
                    <div class="contact-info">
                        ...
                        <div class="contact-info-item">
                            ...
                            <div>
                                <h5>Address</h5>
                                <p>Aptech Def Hyderabad Sindh Pakistan</p>
                            </div>
                        </div>
                        <div class="contact-info-item">
    ...
    <div class="container">
        <div class="cta-section animate__animated animate__fadeInUp">
            <div class="cta-content">
                <h2>Need Travel Assistance?</h2>
                <p>Our travel experts are ready to help you plan your perfect trip. Get in touch with us today for personalized travel recommendations and support.</p>
