        ...
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                <a href="" class="navbar-brand">
                    <h1 class="m-0 text-primary" style="font-size:25px;"><span style="color:black;">Expense</span>Voyage
                    </h1>
                </a>
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    while ($rows = mysqli_fetch_assoc($result)) {
        $userid = $rows['userid']; // Use the userid from the current row
        $sql2 = "SELECT name, profile_image FROM user WHERE id = $userid"; // Fetch user details
        ...
        if ($user_row) {
            echo '<div class="text-center pb-4">
                    <img class="img-fluid mx-auto" src="img/reviewerimages/' . htmlspecialchars($user_row['profile_image']) . '" style="width: 100px; height: 100px;">
                    <div class="testimonial-text bg-white p-4 mt-n5">
                        <p class="mt-5">' . htmlspecialchars($rows['usermessage']) . '</p>
                        <h5 class="text-truncate">' . htmlspecialchars($user_row['name']) . '</h5>
                    </div>
                </div>';
        } else {
            ...
            echo '<div class="text-center pb-4">
                    <div class="testimonial-text bg-white p-4 mt-n5">
                        <p class="mt-5">' . htmlspecialchars($rows['usermessage']) . '</p>
                        <h5 class="text-truncate">User not found</h5>
                    </div>
                </div>';
        }
    }
