...
if(isset($_POST['addblog'])){
    $blogtitle = mysqli_real_escape_string($con, $_POST['title']);
    $blogdesc = mysqli_real_escape_string($con, $_POST['description']);
...
<head>
       ...
       <title>Add Blog - ExpenseVoyage</title>
                ...
                <ul>
                    ...
                    <li class="submenu open">
                        ...
                        <ul>
                            ...
                            <li><a href="addblog.php" class="active"> Add Blog </a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <h5 class="card-title mb-4">Blog Detail</h5>
                                    <div class="row">
                                        <div class="col-xl-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description" rows="6" required placeholder="Enter blog description"></textarea>
                                            </div>
                                        </div>
