...
if (isset($_POST['submit'])) {
    ...
    $a_profetion = mysqli_real_escape_string($con, $_POST['a_profetion']);
    ...
    if (isset($_FILES['a_image']) && $_FILES['a_image']['error'] === 0) {
        ...
        if (in_array($fileType, $allowedTypes)) {
            ...
            if (move_uploaded_file($image['tmp_name'], $imagePath2)) {
                ...
                if ($stmt->execute()) {
                    ...
                    window.location.href='addagent.php';</script>";
                } else {
...
if (isset($_GET['delete_id'])) {
    ...
    $get_image_sql = "SELECT a_image FROM agent WHERE id = ?";
    $stmt = $con->prepare($get_image_sql);
    ...
    if ($result->num_rows > 0) {
        ...
        $image_to_delete = '../upload/agents/' . $row['a_image'];
...
<head>
    ...
    <title>Add Agent - ExpenseVoyage</title>
                ...
                <ul>
                    ...
                    <li class="submenu open">
                        ...
                        <ul>
                            ...
                            <li><a href="addagent.php" class="active"> Add agent </a></li>
                        </ul>
                    </li>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="a_name" class="form-control" required placeholder="Enter agent name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">Agent Profession</label>
                                        <input type="text" name="a_profetion" class="form-control" required placeholder="Enter agent profession">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="a_image" class="form-control" required accept="image/*">
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . htmlspecialchars($row['a_profetion']) . "</td>";
                                            echo "<td><img src='upload/agents/" . htmlspecialchars($row['a_image']) . "' width='60' height='60' alt='Agent Profile'></td>";
                                            echo "<td>
                                                <a href='addagent.php?delete_id=" . $row['id'] . "' onclick='return confirm(\"Are you sure you want to delete this agent?\")' class='btn btn-danger btn-sm'>
                                        ...
                                        echo "<tr><td colspan='4' class='text-center'>No agents found</td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
