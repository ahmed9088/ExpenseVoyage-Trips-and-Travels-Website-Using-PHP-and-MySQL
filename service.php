...
<head>
    <meta charset="utf-8">
    <title>Our Services - ExpenseVoyage</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Premium Travel Services by ExpenseVoyage" name="keywords">
    <meta content="Explore our comprehensive travel services including visa assistance, flight bookings, guided tours, and more" name="description">
    ...
    color: white;
        ...
        /* Page Header */
        .page-header {
            background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('img/service-bg.jpg');
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="service.php" class="nav-item nav-link active animate__animated animate__fadeInDown">Services</a>
    ...
    <section class="services">
        <div class="container">
            <div class="text-center mb-5">
                <h6 class="text-primary text-uppercase" style="font-size: 30px;">Our Services</h6>
                <h1 class="section-title" style="color:black">Premium Travel Services</h1>
                <p class="lead">We offer comprehensive travel services to make your journey unforgettable</p>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 animate__animated animate__fadeInUp" style="animation-delay: 0.1s;">
                    <div class="service-item">
                        ...
                        <p>We help you with the visa application process, ensuring smooth travel across borders. Our experts handle all documentation and requirements.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 animate__animated animate__fadeInUp" style="animation-delay: 0.2s;">
                    <div class="service-item">
                        ...
                        <h5>Flight Services</h5>
                        <p>Book your flights with ease and enjoy competitive pricing for both domestic and international trips. We find the best deals for you.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 animate__animated animate__fadeInUp" style="animation-delay: 0.3s;">
                    <div class="service-item">
                        ...
                        <h5>Guided Tours</h5>
                        <p>Explore new destinations with our expert-guided tours, designed for a memorable experience. Discover hidden gems with local insights.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 animate__animated animate__fadeInUp" style="animation-delay: 0.4s;">
                    <div class="service-item">
                        ...
                        <h5>Hotel Booking</h5>
                        <p>Stay at the best hotels at affordable rates. We handle all your accommodation needs, from luxury resorts to cozy boutique hotels.</p>
                    </div>
                </div>
                
                <div class="col-lg-4 col-md-6 animate__animated animate__fadeInUp" style="animation-delay: 0.5s;">
                    <div class="service-item">
                        <div class="service-icon">
                            <i class="fas fa-umbrella-beach"></i>
                        </div>
                        <h5>Vacation Packages</h5>
                        <p>Tailor-made vacation packages that provide great value and unforgettable experiences. We customize every detail to match your preferences.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 animate__animated animate__fadeInUp" style="animation-delay: 0.6s;">
                    <div class="service-item">
                        ...
                        <p>Comprehensive travel insurance to protect you against unforeseen travel issues. Travel with peace of mind knowing you're covered.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="service-process">
                <div class="text-center mb-5">
                    <h6 class="text-primary text-uppercase" style="font-size: 30px;">How It Works</h6>
                    <h1 class="section-title" style="color:black">Our Simple Process</h1>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-md-3 animate__animated animate__fadeInUp" style="animation-delay: 0.1s;">
                        <div class="process-step">
                            ...
                            <h5 class="process-title">Explore</h5>
                            <p>Browse our wide range of destinations and services to find what suits your preferences.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 animate__animated animate__fadeInUp" style="animation-delay: 0.2s;">
                        <div class="process-step">
                            ...
                            <h5 class="process-title">Consult</h5>
                            <p>Discuss your requirements with our travel experts who will guide you through the options.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 animate__animated animate__fadeInUp" style="animation-delay: 0.3s;">
                        <div class="process-step">
                            ...
                            <h5 class="process-title">Book</h5>
                            <p>Secure your booking with flexible payment options and instant confirmations.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 animate__animated animate__fadeInUp" style="animation-delay: 0.4s;">
                        <div class="process-step">
                            ...
                            <h5 class="process-title">Travel</h5>
                            <p>Enjoy your journey with our 24/7 support and assistance throughout your trip.</p>
                        </div>
                    </div>
                </div>
            </div>
