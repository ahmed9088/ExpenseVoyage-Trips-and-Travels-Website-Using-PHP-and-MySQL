...
<head>
   ...
   <title>User List - ExpenseVoyage</title>
...
<body>
    ...
    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="userdelete.php?id=<?php echo $row[0]; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');">
